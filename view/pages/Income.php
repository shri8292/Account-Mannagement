   ...
   <?php include '../header.php'; ?>
    <div id="wrapper">
      ...
      <div class="card card-login mx-auto mt-5">
        <div class="card-header">Income Form</div>
        <div class="card-body">
          <?php
          if(isset($_GET['msg'])){
            if($_GET['msg']='success'){
          ...
          <form name="myform" method="post" action="../../controller/income_controller.php">
            <input type="hidden" name="opn" value="add">            
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" name="inc" id="inc" class="form-control" placeholder="Income From" required autofocus="autofocus">
                <label for="inc">Income From</label>
              </div>
            </div>
            <div class="form-group">
              <div class="form-label-group">
              ...
              <select name="inccat" class="form-control"  required>
               <option value="-1">Select Income Category</option>
               <?php
                  while ($row = mysqli_fetch_array($res)) 
                  {                  
                  echo'<option value="'.$row['inc_catid'].'">'.$row['inc_catname'].'</option>';
                  }    
               ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select name="receiveby" class="form-control"  required>
               <option value="-1">Receive By</option>              
