   ...
   <?php include '../header.php'; ?>
    <div id="wrapper">
      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form name="myform" method="post" action="Balance_Sheet.php">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tr> <th colspan="3">Total Incomes : <?php echo $total1; ?></th> </tr>
                </table>
              </div>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    ?>
                  <tr> <th colspan="3">Total Expenses : <?php echo $total2; ?></th> </tr>                    
                  </tbody>
                </table>
              </div>
            </div>
    ...
    <div class="container my-auto">
      ...
      <br /><br />
         <div style="background-color:gray; color:white">
            <?php
               if($total1>$total2){
                  echo 'Gross Profit : '.($total1-$total2);         
               }else{
                  echo 'Gross Loss : '.($total1-$total2);                        
               }
            ?>         
         </div>
      </div>
